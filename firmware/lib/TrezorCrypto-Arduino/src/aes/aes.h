...
AES_RETURN aes_encrypt_trezor(const unsigned char *in, unsigned char *out, const aes_encrypt_ctx cx[1]);
...
AES_RETURN aes_decrypt_trezor(const unsigned char *in, unsigned char *out, const aes_decrypt_ctx cx[1]);
